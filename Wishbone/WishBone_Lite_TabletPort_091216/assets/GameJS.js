...
var randomdetails = function() {
	...
	if(whichimage % 2 == 0){
		document.getElementById("img1").style.backgroundImage = "url(https://a.mnectar.com/uploads/creative/162/1232/" +questions[i].img + ")";
	}else{
		document.getElementById("img2").style.backgroundImage = "url(https://a.mnectar.com/uploads/creative/162/1232/" +questions[i].img + ")";
	}
	setTimeout(function(){
